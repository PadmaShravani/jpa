...
public class PRGSRunner {
	...
	public static void main(String[] args) {
		...
		ModelUsers mUser=new ModelUsers(1,"satish","1234","satish kumar","satish@gmail.com","22nd sep 1983");
		UsersServiceClass us=new UsersServiceClass();
		us.createModelUsers(mUser);
		
		ModelTicketDetails mTicket=new ModelTicketDetails(10,"complaint",2,"electric","street light not working","abcd","pic","open");
		ServiceTicketDetailsClass sts=new ServiceTicketDetailsClass();
		sts.createModelTicketDetails(mTicket);
		
		ModelService mService=new ModelService(6,"replace light","open",3);
